...
pub struct Keygen {
    ...
    msgs1: Option<Store<BroadcastMsgs<party_i::KeyGenBroadcastMessage1>>>,
    msgs2: Option<Store<BroadcastMsgs<party_i::KeyGenDecommitMessage1>>>,
...
enum M {
    Round1(party_i::KeyGenBroadcastMessage1),
    Round2(party_i::KeyGenDecommitMessage1),
